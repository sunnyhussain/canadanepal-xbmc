...
def show_search_box(name, url, language, mode):
    ...
    if (keyb.isConfirmed()):
        ...
        headers={'Origin':'https://einthusan.com','Referer':'https://einthusan.tv/movie/browse/?'+url,'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'}
...
def play_video(name, url, language, mode):
    ...
    if isithd=='itshd':
        ...
        if ret ==0:
            # isithd = 'itshd'
            headers={'Origin':'https://einthusan.com','Referer':'https://einthusan.tv/movie/browse/?lang=hindi','User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'}
...
def login_info(s, referurl):
    ...
    headers={'Host':'einthusan.com', 'Origin':'https://einthusan.tv','Referer':referurl,'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36'}
